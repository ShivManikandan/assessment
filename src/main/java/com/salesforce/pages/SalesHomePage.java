...
import com.salesforce.testcases.Assesment;
...
public class SalesHomePage extends ProjectSpecificMethods {
	...
	public Reportspage navigateToReportrScreen() 
	{
		clickUsingJs(locateElement(Locators.XPATH, "//a[@role='menuitem']//span[text()='Reports']"));
		reportStep("Reports Displayed Successfully", "pass");
